package hackbulgaria.corejava.week0.tests;

import static org.junit.Assert.*;
import hackbulgaria.corejava.week0.UPJava;

import java.util.Arrays;

import org.junit.*;

public class UPJavaTests {
    
    private final UPJava problems2 = new UPJava();
    ...
    @Test
    public void testMin() {
        int[] array = {1, 3, 4, 5, 6, -1, 23, -125, 125125, -63262, 2151, -1212};
        int min = problems2.minElem(array);
        assertTrue(min == -63262);
        
        int[] array2 = {-1, 0, 1, 1, -1, -9, 0, 5};
        min = problems2.minElem(array2);
        assertTrue(min == -9);
    }
